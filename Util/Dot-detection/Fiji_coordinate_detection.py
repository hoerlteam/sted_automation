...
def call_fiji(Fiji_path, macro, image_path, series=1, threshold=1):
    ...
    import subprocess
    function_call = '{path_to_Fiji} {macro_path} {image_path} {series_number} {thresh}'.format(**fiji_params)
...
def find_hssites(fiji_path,
                 macro_path, image_path, fov_dimensions, global_coordinates,
                 coords_temp_path="coords-temp"):
    ...
    actual_spot_coords = corner2spot(corner_coords, sites, image_path, fov_dimensions)
    return actual_spot_coords
