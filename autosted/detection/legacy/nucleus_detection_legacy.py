...
from autosted.utils.parameter_constants import (OFFSET_SCAN_PARAMETERS, OFFSET_STAGE_GLOBAL_PARAMETERS,
...
if __name__ == '__main__':
    ...
    from autosted.callback_buildingblocks.coordinate_value_wrappers import ScanFieldSettingsGenerator
